        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-agro-brown-700 mb-1">
                  Confirmar Senha
                </label>
                <input
                  id="confirmPassword"
            ...
            <div className="text-center text-sm">
              <span className="text-agro-brown-600">Já tem uma conta? </span>
              <Link href="/signin" className="text-agro-green-600 hover:text-agro-green-700 font-medium">
                Entrar
              </Link>
            </div>
          </form>
